  ...
  callback() {
    if (this.render) {
      ...
      this.categories.forEach(category => {
        ...
        /*=======================================================================
        Tomamos la colección de los productos filtrando con las url de categorías
        =======================================================================*/
            ...
            for (i in arrayProducts) {
              if (category.url == arrayProducts[i].category) {
                ...
                if (arrayProducts[i].offer != "") {
                  ...
                  price = `<p class="ps-product__price sale">$${arrayProducts[i].price}</p>`;
                }
                ...
                if(arrayProducts[i].stock == 0){
                  disccount = `<div class="ps-product__badge out-stock">Agotado</div>`;
                }
                ...
                <div class="ps-product ps-product--simple">
                  ...
                  <div class="ps-product__thumbnail">
                    ...
                    <a href="product/${arrayProducts[i].url}">
                      ...
                      <img src="assets/img/products/${arrayProducts[i].category}/${arrayProducts[i].image}" alt=""></a>
